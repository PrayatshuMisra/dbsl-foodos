...
-- creates 10 dummy customers, 3 owners, restaurants, 
...
BEGIN
  ...
  -- ==========================================
  -- Cascade ensures related data in order_details, orders, etc., are also removed.
  ...
  -- ==========================================
  -- 6. CREATE DELIVERY PARTNERS & COUPONS
  -- ==========================================
